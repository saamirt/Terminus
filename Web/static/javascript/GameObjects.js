...
//WESTERN FOREST
export let WesternForest = new Room(
	"WesternForest",
...
export let SpellCastingAcademy = new Room(
	"SpellCastingAcademy",
...
export let HurryingStudent = new Item(
	"HurryingStudent",
...
//PRACTICE ROOM
export let PracticeRoom = new Room(
	"PracticeRoom",
...
//NORTHERN MEADOW
export let NorthernMeadow = new Room(
	"NorthernMeadow",
...
//EASTERN MOUNTAINS
export let EasternMountains = new Room(
	"EasternMountains",
...
//DARK CORRIDOR
export let DarkCorridor = new Room(
	"DarkCorridor",
...
//STONE CHAMBER
export let StoneChamber = new Room(
	"StoneChamber",
...
//---------------LEVEL 2---------------------
//TOWN SQUARE
export let TownSquare = new Room(
	"TownSquare",
...
//MARKETPLACE
export let Marketplace = new Room(
	"Marketplace",
	"Vendors and their goods line the streets.",
	"loc_market.gif",
	["-510px", "-50px"]
);
export let Vendor = new Item(
	"Vendor",
...
//export let Backpack = new Item("Backpack", "There's a beat-up looking backpack on the table with no price tag.  Its cloth looks \n" +
...
export let MkdirSpell = new Item(
	"mkdirSpell",
...
//ROCKY PATH
export let RockyPath = new Room(
	"RockyPath",
	"The weed-choked path leads off into the fields.",
	"loc_rockypath.gif",
	["-510px", "-50px"]
);
export let LargeBoulder = new Item(
	"LargeBoulder",
...
//ARTISAN'S SHOP
export let ArtisanShop = new Room(
	"ArtisanShop",
...
export let StrangeTrinket = new Item(
	"StrangeTrinket",
	"It looks like a crystal of some sort. It's very beautiful.",
	"item_trinket.gif"
);
StrangeTrinket.addCmdText(
	"rm",
...
export let ClockworkDragon = new Item(
	"ClockworkDragon",
...
Clearing.addCmdText(
	"cd",
	"You can’t cross the bridge until you’ve replaced the missing Plank."
);
...
//BROKEN BRIDGE
export let BrokenBridge = new Room(
	"BrokenBridge",
...
export let OminousLookingPath = new Room(
	"OminousLookingPath",
...
export let ThornyBrambles = new Item(
	"ThornyBrambles",
...
//SLIDE
export let Slide = new Room(
	"Slide",
	"The slides is long. At the end, you see the KernelFiles."
);
Slide.removeCommand("cd");
Slide.addCmdText("cd", "You have to get past the UglyTroll first.");

//KERNEL FILES
export let KernelFiles = new Room(
	"KernelFiles",
	"The KernelFiles hold the sudo-secret (no, not \
pseudo). You'd better read the Instructions."
);
export let Certificate = new Item(
	"Certificate",
	"You must read the Certificate with the sudo password."
);
KernelFiles.addItem(Certificate);
export let Instructions = new Item(
	"Instructions",
	"You've learned how to make use of your friend grep I see. \
...
// export let N_txt = new Item("N_txt", "INSERT SOME LONG TEXT");
// export let O_txt = new Item("O_txt", "INSERT SOME LONG TEXT");
// export let P_txt = new Item("P_txt", "INSERT SOME LONG TEXT");
export let Q_txt = new Item(
	"Q_txt",
	"Alice was beginning to get very tired of sitting by her \n\
sister on the bank, and of having nothing to do: once or twice she had peeped into the \n\
book her sister was reading, but it had no pictures or conversations in it, 'and what is \n\
...
// export let X_txt = new Item("X_txt", "INSERT SOME LONG TEXT");
// export let Y_txt = new Item("Y_txt", "INSERT SOME LONG TEXT");
// export let Z_txt = new Item("Z_txt", "INSERT SOME LONG TEXT");
// export let AA_txt = new Item("AA_txt", "INSERT SOME LONG TEXT");
// export let BB_txt = new Item("BB_txt", "INSERT SOME LONG TEXT");
// export let CC_txt = new Item("CC_txt", "INSERT SOME LONG TEXT");
// export let DD_txt = new Item("DD_txt", "INSERT SOME LONG TEXT");
// export let EE_txt = new Item("EE_txt", "INSERT SOME LONG TEXT");
// export let FF_txt = new Item("FF_txt", "INSERT SOME LONG TEXT");
export let MoreKernelFiles = new Room(
	"MoreKernelFiles",
...
KernelFiles.ev.addListener("tryEnterSudo", function() {
	...
	KernelFiles.addCmdText(
		"IHTFP",
		"You have correctly entered the password. You are now in Paradise. \
...
export let CaveOfDisgruntledTrolls = new Room(
...
export let UglyTroll = new Item(
	"UglyTroll",
	"He looks mad, and really ugly.",
	"item_troll1.gif"
);
UglyTroll.addCmdText(
	"rm",
...
UglyTroll.addCmdText(
	"mv",
	"The troll looks briefly surprised, then moves away. He's mostly \
    harmless anyway."
);
...
export let UglierTroll = new Item(
	"UglierTroll",
...
//CAGE
export let Cage = new Room(
	"Cage",
	"There's a scared-looking kid in there.",
	"item_cage.gif",
	["-510px", "-50px"]
);
export let KidnappedChild = new Item(
	"KidnappedChild",
...
Cage.addCmdText(
	"cd",
	"You can’t squeeze through the bars. Anyway, are you crazy? \
    Why would you want to go into a cage?"
);
KidnappedChild.addCmdText(
	"mv",
...
//Athena cluster
export let AthenaCluster = new Room(
	"AthenaCluster",
...
export let Workstation = new Item(
	"Workstation",
...
AthenaCluster.addCmdText(
	"ls",
	"You must enter the Athena cluster combo first."
);
...
//StataCenter
export let StataCenter = new Room(
	"StataCenter",
...
export let WaryEyeOfGradStudent = new Item(
...
other places, you can write notes, and you can store export letious items you collect in \
...
//Magic locker
export let MagicLocker = new Room(
	"MagicLocker",
...
export let MoreComing = new Item(
	"MoreComing",
