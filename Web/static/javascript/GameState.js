...
get started! Just call them gear1, gear2, gear3, gear4, and gear5, please."
			...
			if (re)
				ArtisanShop.addItem(
					new Item("Gear", "This is a Gear", "item_gear.gif")
				);
			else
				ArtisanShop.getItemFromName("Gear").changePicName(
					"item_gear.gif"
				);
			break;
		case "FiveGearsCopied":
			Artisan.addCmdText(
				"less",
				"Ha, finished already? I guess you learn fast. Well, \
thanks for your assistance."
			);
			if (re) {
				ArtisanShop.addItem(
					new Item("gear1", "This is a Gear", "item_gear.gif")
				);
				ArtisanShop.addItem(
					new Item("gear2", "This is a Gear", "item_gear.gif")
				);
				ArtisanShop.addItem(
					new Item("gear3", "This is a Gear", "item_gear.gif")
				);
				ArtisanShop.addItem(
					new Item("gear4", "This is a Gear", "item_gear.gif")
				);
				ArtisanShop.addItem(
					new Item("gear5", "This is a Gear", "item_gear.gif")
				);
			}
			break;
		case "CornCopied":
			...
			if (re)
				Farm.addItem(
					new Item("AnotherEarOfCorn", "This is AnotherEarOfCorn")
				);
			break;
		case "HouseMade":
			if (re) Clearing.addChild(new Room("House", "This is a House"));
			Clearing.getChildFromName("House").addCmdText(
				"cd",
				"You are entering the House that you made."
			);
			Clearing.getChildFromName("House").addCmdText(
				"ls",
...
stone, weeping. Behind him is a pile of rubble and a small white house."
			...
			CryingMan.addCmdText(
				"less",
				"Thank you for making me the House!  Why am I still crying?  These are tears of joy.  Can't a man openly express his emotions?"
			);
			break;
		case "touchPlank":
			...
			BrokenBridge.changeIntroText(
				"A creaky rope bridges stretches across a chasm."
			);
			if (re)
				BrokenBridge.addItem(
					new Item("Plank", "This is a Plank.", "item_plank.gif")
				);
			else
				BrokenBridge.getItemFromName("Plank").changePicName(
					"item_plank.gif"
				);
			break;
		case "rmBrambles":
		...
		case "openSlide":
			...
			Slide.addCmdText(
				"cd",
				"It's just a Slide. Keep going. You're almost at the KernelFiles."
			);
